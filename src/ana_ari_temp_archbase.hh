#ifndef ana_ari_temp_archbase_hh
#define ana_ari_temp_archbase_hh
...
class ana_ari_temp_archbase {

public :
  ana_ari_temp_archbase(TString fileList);
  ana_ari_temp_archbase(TString inFileName, Int_t keyID);
  ~ana_ari_temp_archbase();
...
protected :
  ...
  static const Int_t nChannels = 6;
  static const Int_t nDataLogMax = 100000;
  Int_t           nData;
  Int_t           unixTime[nDataLogMax];
  Float_t         data[nDataLogMax];
  //---------------------------------------------------
